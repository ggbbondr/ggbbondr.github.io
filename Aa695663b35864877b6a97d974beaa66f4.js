...
function(e, t) {
    ...
    r = {
        ...
        ready: function(e) {
            var t = "layer",
            i = "",
            n = "A2288c68f9d69465c9b9c123c1934a5479.css";
    ...
    r.prompt = function(e, t) {
        ...
        var s, l = 2 == e.formType ? '<textarea class="form-control"' + a + ">" + (e.value || "") + "</textarea>": function() {
            return '<input type="' + (1 == e.formType ? "password": "text") + '" class="form-control" value="' + (e.value || "") + '">'
        } (),
        f = e.success;
